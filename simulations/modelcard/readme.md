Avant uses [model cards](https://github.com/avantcredit/avant-analytics/tree/master/models/prod/default/en-US/3.0.0/README.md) to document our work, with an aim for reproducible research.
